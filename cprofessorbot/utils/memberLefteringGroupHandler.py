###############################################################################
# Descripción: Clase manejadora del evento producido cuando el un usuario
#				sale de un grupo o supergrupo
...
class MemberLefteringGroupHandler(Handler):

	"""
	Clase manejadora del evento producido al salir un usuario de un grupo
	o supergrupo
	...
	def __init__(self, callback, pass_update_queue=False, pass_job_queue=False,
		...
		super(MemberLefteringGroupHandler, self).__init__(
			callback,
	...
	def check_update(self, update):
		...
		"""
		Permite detectar el hecho de que un usuario salga de un grupo o
		supergrupo
		...
		if (isinstance(update, Update) and
			...
			#	Se comprueba que algún usuario haya salido de un grupo
